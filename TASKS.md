...
- [ ] **F9.1** Modelo premium cuando el experimento dé señales.
      ...
      - **Claude: hecho en F9.35**, y no por el SDK sino por el comando `claude` y la
        suscripción, que no se factura por token.
...
- [x] **F9.35** **Un tercer perfil con Claude Sonnet 5, por la suscripción y no por la API.**
